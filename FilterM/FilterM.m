...
if isunix
   ...
   % Flags = {'-O', 'COMPFLAGS="$COMPFLAGS', '/O2 /GL /fp:fast"','FilterX.c'};
%    Flags = {'-O', 'COMPFLAGS="$COMPFLAGS', '/GL"','FilterX.c'};
      % Flags = {'-O', 'COMPFLAGS="$COMPFLAGS', '/GL /fp:fast /arch:AVX2"','FilterX.c'};
      % Flags = {'-O', 'COMPFLAGS="$COMPFLAGS', '/O2 /GL /fp:fast /arch:AVX /arch:AVX2"', 'FilterX.c'};
      Flags = {'-v', '-O', 'FilterX.c'};
end
